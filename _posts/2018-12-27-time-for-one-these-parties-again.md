...
Unfortunately, the date of our release party coincided to be in the middle of [massive student protests on the entire country](https://en.wikipedia.org/wiki/2018_student_protest_in_Albania) and that affected the overall participation. 😔  Our event started with an ice-breaking session to get to know better the background of each other better and understand each one’s engagement with Linux and Fedora in particular. 
